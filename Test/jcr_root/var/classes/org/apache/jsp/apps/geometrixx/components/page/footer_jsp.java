...
public final class footer_jsp extends org.apache.sling.scripting.jsp.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    int year = Calendar.getInstance().get(Calendar.YEAR);
      ...
      out.write("\n");
      out.write("<div class=\"footer container_16\">\n");
      out.write("    <div class=\"grid_6\">\n");
      out.write("        <h3>");
      out.print( i18n.get("&copy; {0} Geometrixx Inc.", null, String.valueOf(year)) );
      out.write("</h3>\n");
      out.write("        ");
      ...
      out.write("    <div class=\"grid_6\">\n");
      out.write("        <h3>");
      out.print( i18n.get("Geometrixx Newsletter") );
      out.write("</h3>\n");
      out.write("        <p>");
      out.print( i18n.get("We would like to keep in touch with you. Sign up here to receive our monthly newsletter on the latest products and services from Geometrixx.") );
      out.write("</p>\n");
      out.write("        <div class=\"form_section\">\n");
      out.write("            <form action=\"\" method=\"post\">\n");
      out.write("                <fieldset>\n");
      out.write("                    <div class=\"input_box1\">\n");
      out.write("                        <label for=\"f-newsletter-subscription\" style=\"display: none;\">");
      out.print( i18n.get("Enter your email address") );
      out.write("</label>\n");
      out.write("                        <input class=\"cq-auto-clear\" type=\"text\" value=\"");
      out.print( i18n.get("Your Email Adress") );
      out.write("\" name=\"\" id=\"f-newsletter-subscription\"/>\n");
      out.write("                    </div>\n");
      out.write("                    <input type=\"button\" value=\"\" name=\"\" class=\"sign_up\"/>\n");
      out.write("                </fieldset>\n");
      out.write("            </form>\n");
      out.write("        </div>\n");
      out.write("    </div>\n");
      ...
      out.write("        <h3>");
      out.print( i18n.get("Follow us") );
      out.write("</h3>\n");
      out.write("        <ul>\n");
      out.write("            <li><a href=\"#\"><img class=\"icon_facebook\" src=\"/etc/designs/default/0.gif\" alt=\"\"/> ");
      out.print( i18n.get("Let&rsquo;s get together on Facebook") );
      out.write("</a></li>\n");
      out.write("            <li><a href=\"#\"><img class=\"icon_twitter\" src=\"/etc/designs/default/0.gif\" alt=\"\"/> ");
      out.print( i18n.get("Follow us on Twitter") );
      out.write("</a></li>\n");
      out.write("            <li><a href=\"/content/geometrixx_mobile/");
      out.print( currentPage.getLanguage(true) );
      out.write(".html\"><img class=\"icon_mobile\" src=\"/etc/designs/default/0.gif\" alt=\"\"/> ");
      out.print( i18n.get("We&rsquo;re mobile!") );
      out.write("</a></li>\n");
      out.write("        </ul>\n");
      out.write("    </div>\n");
  ...
  private boolean _jspx_meth_cq_005finclude_005f0(PageContext _jspx_page_context)
    ...
    // /apps/geometrixx/components/page/footer.jsp(27,8) name = path type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_cq_005finclude_005f0.setPath("toolbar");
    // /apps/geometrixx/components/page/footer.jsp(27,8) name = resourceType type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_cq_005finclude_005f0.setResourceType("foundation/components/toolbar");
