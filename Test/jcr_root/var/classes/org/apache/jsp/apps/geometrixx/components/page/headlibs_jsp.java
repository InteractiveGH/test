...
if(!properties.get("cq:lastModified", "").equals("")) {
	...
	String date = sdf.format(properties.get("cq:lastModified", Date.class) );
      ...
      out.write("<meta http-equiv=\"Last-Modified\" content=\"");
      out.print( StringEscapeUtils.escapeHtml4(date) );
      out.write('"');
      out.print(xs);
      out.write('>');
...
if(!properties.get("cq:lastModifiedBy", "").equals("")) {
      ...
      out.print( StringEscapeUtils.escapeHtml4(properties.get("cq:lastModifiedBy", "")) );
      out.write('"');
      out.print(xs);
      out.write('>');
...
if(!properties.get("jcr:title", "").equals("")) {
      ...
      out.print( StringEscapeUtils.escapeHtml4(properties.get("jcr:title", "")) );
      out.write('"');
      out.print(xs);
      out.write('>');
...
if(!properties.get("subtitle", "").equals("")) {
      ...
      out.write("<meta name=\"subtitle\" content=\"");
      out.print( StringEscapeUtils.escapeHtml4(properties.get("subtitle", "")) );
      out.write('"');
      out.print(xs);
      out.write('>');
...
if(properties.get("cq:tags", new String[0]).length > 0) {
      ...
      out.write("<meta name=\"tags\" content=\"");
      out.print( StringEscapeUtils.escapeHtml4( StringUtils.join(properties.get("cq:tags", new String[0]), ",") ) );
      out.write('"');
      out.print(xs);
      out.write('>');
  ...
  private boolean _jspx_meth_cq_005fincludeClientLib_005f0(PageContext _jspx_page_context)
    ...
    //  cq:includeClientLib
    com.adobe.granite.ui.tags.IncludeClientLibraryTag _jspx_th_cq_005fincludeClientLib_005f0 = (com.adobe.granite.ui.tags.IncludeClientLibraryTag) _005fjspx_005ftagPool_005fcq_005fincludeClientLib_005fcategories_005fnobody.get(com.adobe.granite.ui.tags.IncludeClientLibraryTag.class);
    ...
    // /apps/geometrixx/components/page/headlibs.jsp(49,2) name = categories type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_cq_005fincludeClientLib_005f0.setCategories("apps.geometrixx-main");
  ...
  private boolean _jspx_meth_cq_005finclude_005f0(PageContext _jspx_page_context)
    ...
    // /apps/geometrixx/components/page/headlibs.jsp(50,2) name = script type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_cq_005finclude_005f0.setScript("/libs/cq/cloudserviceconfigs/components/servicelibs/servicelibs.jsp");
  ...
  private boolean _jspx_meth_cq_005finclude_005f1(PageContext _jspx_page_context)
    ...
    // /apps/geometrixx/components/page/headlibs.jsp(53,0) name = script type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_cq_005finclude_005f1.setScript("init.jsp");
